...
node.wildfly-node.docker.image=quay.io/wildfly/wildfly-centos7:25.0
...
```properties
node.node0.docker.image=quay.io/wildfly/wildfly-centos7:25.0
...
```bash
mvn test "-Dnode.nodeA.docker.image=quay.io/wildfly/wildfly-centos7:25.0"
```
